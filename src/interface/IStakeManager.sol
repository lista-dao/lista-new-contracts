...
interface IStakeManager {
  ...
  function requestIndexMap(uint256 uuid) external view returns (uint256);
  ...
  function getUserRequestStatus(address _user, uint256 _idx) external view returns (bool _isClaimable, uint256 _amount);
