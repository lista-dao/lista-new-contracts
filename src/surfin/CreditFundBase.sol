  ...
  ReentrancyGuardUpgradeable
{
  ...
  /// @dev check and consume the per-address daily submit limit. Counts submissions per
  ///      day rather than net position, and a consumed allowance is never returned.
